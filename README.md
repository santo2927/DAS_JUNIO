...
<table style="width: 100%; text-align: center;">
  ...
  <tr>
    ...
    <td style="width: 25%; text-align: justify;"><a href="./Iteracion%201/Decision%201.md">Decision 1</a></td>
  </tr>
  <tr>
    ...
    <td style="width: 25%;"><a href="./Iteracion%202/Decision%202.md">Decision 2</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="width: 25%:"><a href="./Iteracion%201/Decision%201.md">Decision 1</a></td>
  </tr>
  <tr>
    ...
    <td style="width: 25%;"><a href="./Iteracion%202/Decision%203_1.md">Decision 3.1</a></td>
  </tr>
  <tr>
    ...
    <td style="width: 25%;"><a href="./Iteracion%202/Decision%203_2.md">Decision 3.2</a></td>
  </tr>
  <tr>
    ...
    <td style="width: 25%;"><a href="./Iteracion%202/Decision%203_3.md">Decision 3.3</a></td>
  </tr>
  <tr>
    ...
    <td style="width: 25%;"><a href="./Iteracion%203/Decision%204.md">Decision 4</a></td>
  </tr>
</table>
<br>
...
<ul>
  <li><a href = "./Iteracion%201/Decision%201.md">Decisión 1</a></li>
</ul>
<br>
<h3 id ="iter-1-uml">UML</h3>
<img src="./Iteracion%201/uml-iter1.png">
<br>
<h2 id = "iter-2">ITERACIÓN 2</h2>
<h3 id ="iter-2-decitions">DECISIONES</h3>
<ul>
  <li><a href = "./Iteracion%202/Decision%202.md">Decisión 2</a></li>
  <li><a href = "./Iteracion%202/Decision%203_1.md">Decisión 3.1</a></li>
  <li><a href = "./Iteracion%202/Decision%203_2.md">Decisión 3.2</a></li>
  <li><a href = "./Iteracion%202/Decision%203_3.md">Decisión 3.3</a></li>
</ul>
<br>
<h3 id="iter-2-uml">UML</h3>
<img src="./Iteracion%202/uml-iter2.png">
<br>
<h2 id = "iter-3">ITERACIÓN 3</h2>
<h3 id ="iter-3-decitions">DECISIONES</h3>
<ul>
  <li><a href="./Iteracion%203/Decision%204.md">Decision 4</a></li>
</ul>
<br>
<h3 id ="iter-3-uml">UML</h3>
<img src="./Iteracion%203/uml-iter3.png">
<br>
<h2 id = "iter-final">ITERACIÓN FINAL</h2>
<h3 id ="iter-final-decitions">DECISIONES</h3>
<ul>
  <li><a href = "./Iteracion%204/Decision%205.md">Decision 5</a></li>
</ul>
<br>
<h3 id ="iter-final-uml">UML</h3>
<img src="./Iteracion%204/uml-iter-final.png">
<img src="./Iteracion%204/deploy-final.png">
<br>
